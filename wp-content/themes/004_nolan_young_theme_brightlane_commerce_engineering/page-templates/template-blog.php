...
<main id="primary" class="site-main page-blog">
	<section class="section page-hero"><div class="container narrow"><p class="eyebrow"><?php esc_html_e( 'Blog', '004-nolan-young-theme-brightlane-commerce-engineering' ); ?></p><h1><?php esc_html_e( 'Website planning and WordPress guidance.', '004-nolan-young-theme-brightlane-commerce-engineering' ); ?></h1><?php get_search_form(); ?></div></section>
