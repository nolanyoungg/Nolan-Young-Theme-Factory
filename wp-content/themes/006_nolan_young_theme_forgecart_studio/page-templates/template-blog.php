...
<main id="primary" class="site-main page-blog">
	<section class="section page-hero"><div class="container narrow"><p class="eyebrow"><?php esc_html_e( 'Blog', 'nolan-young-template' ); ?></p><h1><?php esc_html_e( 'Planning guidance for WordPress sites, Shopify stores, and launch operations.', 'nolan-young-template' ); ?></h1><?php get_search_form(); ?></div></section>
