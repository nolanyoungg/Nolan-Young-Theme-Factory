...
function nolan_young_template_setup() {
	load_theme_textdomain( '004-nolan-young-theme-brightlane-commerce-engineering', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'primary' => esc_html__( 'Primary Navigation', '004-nolan-young-theme-brightlane-commerce-engineering' ),
			'footer'  => esc_html__( 'Footer Navigation', '004-nolan-young-theme-brightlane-commerce-engineering' ),
		)
	);
}
