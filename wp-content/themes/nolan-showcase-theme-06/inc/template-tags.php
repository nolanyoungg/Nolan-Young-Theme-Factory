...
function nolan_primary_menu_fallback() {
	$items = array(
		array(
			'label'    => __( 'Home', 'nolan-showcase-theme-06' ),
			'url'      => home_url( '/#home' ),
			'children' => array(),
		),
		array(
			'label'    => __( 'Explore', 'nolan-showcase-theme-06' ),
			'url'      => home_url( '/#work' ),
			'children' => array(
				array( 'label' => __( 'Featured Work', 'nolan-showcase-theme-06' ), 'url' => home_url( '/#work' ) ),
				array( 'label' => __( 'Services', 'nolan-showcase-theme-06' ), 'url' => home_url( '/#services' ) ),
				array( 'label' => __( 'Journal', 'nolan-showcase-theme-06' ), 'url' => home_url( '/#blog' ) ),
				array( 'label' => __( 'Contact', 'nolan-showcase-theme-06' ), 'url' => home_url( '/#contact' ) ),
			),
		),
		array( 'label' => __( 'Contact', 'nolan-showcase-theme-06' ), 'url' => home_url( '/#contact' ) ),
	);
