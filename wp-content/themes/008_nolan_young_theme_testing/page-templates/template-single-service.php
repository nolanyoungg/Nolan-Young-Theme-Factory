...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Service detail', '008_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Custom software built around one high-value workflow.', '008_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Each service page clarifies the value proposition, deliverables, process, frequently asked questions, and next step for a focused project.', '008_nolan_young_theme_testing' ); ?></p>
      </div>
