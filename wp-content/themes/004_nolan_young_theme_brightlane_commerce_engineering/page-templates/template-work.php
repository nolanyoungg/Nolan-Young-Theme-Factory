...
<main id="primary" class="site-main page-work">
	<section class="section page-hero"><div class="container narrow"><p class="eyebrow"><?php esc_html_e( 'Work', '004-nolan-young-theme-brightlane-commerce-engineering' ); ?></p><h1><?php esc_html_e( 'Representative website projects and problem types.', '004-nolan-young-theme-brightlane-commerce-engineering' ); ?></h1><p><?php esc_html_e( 'These examples show the kinds of strategy, design, development, integration, support, and results-focused work the theme is built to present.', '004-nolan-young-theme-brightlane-commerce-engineering' ); ?></p></div></section>
