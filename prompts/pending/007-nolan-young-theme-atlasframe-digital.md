...
For this theme, use `Atlasframe Digital`.

### Business Logo

Create an original local SVG logo mark for Atlasframe Digital using a precise geometric frame symbol, a subtle grid motif, and clean wordmark typography. The mark should feel technical, premium, and suitable for a WordPress design and development studio. Do not use third-party logos or copied brand marks.

### Business Slogan

WordPress systems, designed for momentum.

### Business Field

Atlasframe Digital is a premium WordPress design, custom theme development, WooCommerce, integration, and long-term website care studio for growth-focused service businesses and ecommerce teams. The brand should feel editorial, technical, trustworthy, and conversion-minded without making unsupported claims about awards, clients, locations, certifications, or guarantees.

### Business Positioning

Atlasframe Digital helps established service companies and lean ecommerce teams turn scattered WordPress sites into maintainable growth systems. The business is not a generic web design shop; it specializes in custom WordPress theme systems, WooCommerce storefronts, performance-minded redesigns, editorial content architecture, and practical integrations that reduce manual work.

The site should communicate:

- Clear technical judgment without sounding academic.
- Premium design taste without feeling decorative or agency-generic.
- Practical business outcomes without inventing guarantees, client names, awards, certifications, revenue numbers, or testimonials.
- A calm, senior, systems-oriented process for teams that need a better website foundation.

### Audience

Primary audience:

- Business owners, marketing leads, ecommerce operators, and small internal teams who already have a WordPress site but need it redesigned, rebuilt, clarified, or connected to operational systems.

Secondary audience:

- Founders and service operators planning a new WordPress launch who care about maintainability, content quality, conversion paths, and a professional customer experience.

Audience concerns to address:

- Their current site is hard to update.
- Design no longer matches the quality of the business.
- Pages are unclear, slow, or not converting.
- Their team depends on too many manual processes.
- Prior sites were built as one-off projects instead of maintainable systems.
- They want a partner who can explain tradeoffs clearly.

### Voice and Copy Style

Use concise, editorial, senior-consultant language. The copy should be specific and useful, not hype-heavy.

Use phrases like:

- planned WordPress systems
- cleaner content paths
- conversion-ready page structures
- maintainable theme foundations
- practical integrations
- measured launches
- care plans that keep the site useful
...
- unicorn, rocket ship, or startup cliches

### Primary Services

Use these six services consistently across header panels, homepage services, Services page, footer, service detail content, Work page references, and CTAs:

1. WordPress Design
   - Purpose: UX direction, page architecture, visual systems, responsive layouts, conversion paths.
   - Ideal customer: Teams whose current site looks dated or has unclear page flow.
   - Deliverables: sitemap direction, wireframe-level page planning, visual system, reusable layout patterns.

2. Custom Theme Development
   - Purpose: bespoke WordPress theme builds using clean templates, reusable components, SCSS, accessible JavaScript, and documented structure.
   - Ideal customer: Teams that need a maintainable custom theme instead of a fragile page-builder stack.
   - Deliverables: custom templates, template parts, build pipeline, documentation, editor-ready settings.

3. WooCommerce
   - Purpose: ecommerce storefront structure, product presentation, checkout support, merchandising sections, and operational clarity.
   - Ideal customer: Product teams that need a stronger storefront experience on WordPress.
   - Deliverables: storefront UX, product/category presentation, conversion sections, integration planning.

4. Website Redesign
   - Purpose: turn an existing site into a sharper, faster, clearer WordPress presence.
   - Ideal customer: Businesses with stale messaging, weak navigation, inconsistent pages, or slow performance.
   - Deliverables: content audit, page redesign, template refresh, migration guidance, launch QA.

5. Integrations & Automation
   - Purpose: connect WordPress forms, subscriber flows, CRM handoffs, reporting, and operational workflows.
   - Ideal customer: Teams manually copying lead, customer, or content data between tools.
   - Deliverables: form strategy, data flow planning, integration-ready architecture, admin workflows.

6. Website Care & Support
   - Purpose: ongoing updates, quality checks, small improvements, content support, and technical stewardship.
   - Ideal customer: Teams that need their site to stay stable and useful after launch.
   - Deliverables: maintenance rhythm, update support, monitoring checklist, improvement backlog.

### Engagement Options

Use these three non-priced engagement cards. Do not invent prices.

1. Foundation Sprint
   - For teams that need a focused strategy and page-structure reset.
   - Include discovery, sitemap direction, homepage/content priorities, and technical recommendations.

2. Custom Theme Build
   - For teams ready for a full custom WordPress design and development project.
   - Include design system, custom templates, component buildout, responsive QA, and launch support.

3. Ongoing Website Care
   - For teams that want continued support after launch.
   - Include updates, incremental improvements, content support, and quality checks.

### Process

Use this process language consistently:

1. Diagnose
   - Clarify goals, audience, content issues, technical constraints, and what the site needs to support.

2. Frame
   - Plan the sitemap, page roles, service hierarchy, conversion paths, and technical approach.

3. Design
   - Build a visual system and page compositions that make the business easier to understand.

4. Develop
   - Implement the WordPress theme, templates, SCSS, JavaScript behavior, forms, and admin-facing features.

5. Validate
   - Check responsive behavior, accessibility, build output, PHP quality, forms, navigation, and content consistency.

6. Support
   - Provide post-launch care, small improvements, documentation, and practical next steps.

### Differentiators

Use these as proof points instead of fake testimonials:

- Custom theme architecture instead of generic page-builder sprawl.
- Clear service taxonomy and navigation before visual polish.
- Real WordPress templates, reusable parts, and documented build outputs.
- Practical forms, newsletter handling, and admin workflows included in the theme.
- Accessibility, responsive behavior, and reduced-motion support treated as core requirements.
- Launch-ready documentation for handoff and ongoing care.

### Contact and Business Details

Use `hello@atlasframe.digital` as the primary email when contact information is needed.
...
If response-time copy is needed, use cautious language such as: `Share the project context and Atlasframe Digital will follow up with a practical next step.` Do not promise a specific response window.

### Page Content Map

Homepage:

- Lead with the headline: `WordPress systems, designed for momentum.`
- Supporting idea: Atlasframe Digital plans, designs, and builds maintainable WordPress sites for teams that need clearer content, better structure, and a site they can keep improving.
- Primary CTA: `Start a Project` linking to `/contact/`.
- Secondary CTA: `Explore Work` linking to `/work/`.
- Include a compact proof row using non-testimonial signals: `Custom theme systems`, `WooCommerce-ready`, `Care after launch`, `Accessible interactions`.

About page:

- Explain the company as a focused WordPress systems studio.
- Emphasize clear diagnosis, careful planning, maintainable implementation, and calm handoff.
- Include values: clarity before decoration, structure before scale, accessibility by default, documentation as part of delivery, support after launch.
- Do not invent founder or team biographies.

Services page:

- Present the six primary services with clear service cards.
- Include guidance that helps visitors choose between a Foundation Sprint, Custom Theme Build, and Ongoing Website Care.
- Include a process section and service FAQ.

Single service page:

- Make it reusable for the six services.
- Use service-specific content, deliverables, ideal customer guidance, related services, and the single-service inquiry form.

Work page:

- Use fictional but non-client-specific project cards framed as project types or anonymized examples.
- Do not imply real client endorsements.
- Use categories: Strategy, Design, Development, Integration, Support, Results.
- Example work cards:
  - `Service Website Reframe`
  - `WooCommerce Catalog Refresh`
  - `Membership Content System`
...
- Create useful article cards with generated destinations.
- Use these article topics:
  - `How to Tell When a WordPress Site Needs a Rebuild`
  - `What a Custom Theme Should Include Before Launch`
  - `Planning Service Pages That Help Buyers Decide`
  - `Reducing Manual Lead Handoffs from WordPress`
  - `A Practical Website Care Checklist`
  - `WooCommerce Storefront Signals That Build Confidence`

Contact page:

- Focus on helping the visitor describe the project clearly.
- Include the Contact form.
- Use guidance prompts: current site, goals, timeline context, must-have functionality, and support needs.
- Do not ask for unnecessary sensitive information.

Policy page:

- Render WordPress-managed policy content only.
- Do not invent legal terms, privacy claims, cookie policy language, or compliance guarantees.

### FAQ Topics

Include at least these seven FAQ topics in appropriate pages:

1. How do we know whether we need a redesign or a rebuild?
2. Can Atlasframe Digital work with an existing WordPress site?
3. What should we prepare before starting?
4. Does every project include WooCommerce?
5. How are integrations handled?
6. What happens after launch?
7. Can the theme be maintained by an internal team?

### Approved Image Usage Plan

Use the seeded image inventory intentionally:

- `assets/images/hero/agency-workspace.jpg`
  - Homepage hero, final CTA, or primary brand statement.
- `assets/images/hero/developer-screens.jpg`
  - Services dropdown, Custom Theme Development service, technical process sections.
- `assets/images/portfolio/ecommerce-planning.jpg`
  - WooCommerce service, ecommerce case-study card, Work page.
- `assets/images/portfolio/team-collaboration.jpg`
  - About page, process section, customer experience section.
- `assets/images/portfolio/performance-review.jpg`
  - Website Redesign, performance support, results-oriented work card.
- `assets/images/texture/studio-detail.jpg`
  - Subtle section texture, dark proof sections, footer or CTA background crop.

Do not use these images as generic placeholders. Tie every image to specific content. Use empty alt text only for purely decorative texture use.
...
Use the following Atlasframe Digital palette consistently throughout the theme. This palette replaces the default template palette. Remove stale default-template color tokens when they conflict with this direction.

| Purpose | Color |
|---|---|
| Main background | `#f8faf7` |
| Secondary background | `#eef3f0` |
| Warm panel | `#fff7ed` |
| Dark background | `#111827` |
| Deep ink | `#0b1120` |
| Primary brand | `#3656f5` |
| Primary brand hover | `#283fd0` |
| Secondary brand | `#0f9f8f` |
| Accent | `#d97706` |
| Soft accent | `#f2c078` |
| Primary text | `#111827` |
| Muted text | `#5f6f7d` |
| Border and divider | `#d8e0dc` |
| Dark section text | `#f8faf7` |

### Primary Button Colors

The primary button background must be `#3656f5`, and the text must be `#ffffff`.

On hover, the background must become `#283fd0`, while the text remains `#ffffff`.

The focus-visible state must remain highly visible and must not rely on the hover state alone.

### Secondary Button Colors

The secondary button background must be `#f8faf7`, the text must be `#111827`, and the border must be `#d8e0dc`.

On hover, the background must become `#eef3f0`, while the text remains `#111827`.

### Additional Color Rules

Use the dark ink background sparingly for proof sections, process explanations, case-study details, final CTA areas, and high-emphasis content.
...
Use amber only for small highlights, priority indicators, warnings, editorial dividers, or high-priority CTA accents.
...
Create a premium, modern, content-forward WordPress systems studio website for Atlasframe Digital.

The design should feel like a quiet technical editorial publication crossed with a practical service-business site. It should be structured, precise, warm, and easy to scan. Avoid a generic SaaS dashboard look, oversized empty hero treatments, and decorative card clutter.

The visual language should use:

- Clean editorial grids.
- Intentional image crops from the approved inventory.
- Compact proof rows and service summaries.
- Thin rule lines, restrained borders, and layered warm panels.
- Technical frame, grid, and pathway motifs created as local SVG or CSS decoration.
- Dark ink sections only where they clarify contrast and emphasis.
- Accessible motion that reveals structure without distracting from the content.

The homepage should immediately signal:

- Atlasframe Digital is a WordPress-focused design and development studio.
- The work is structured, maintainable, and business-aware.
- Visitors can choose between planning, full custom builds, ecommerce support, integrations, and ongoing care.

Avoid:

- One-note blue/purple gradients.
- Generic startup copy.
- Placeholder “case studies” pretending to be real clients.
- Huge hero type that breaks mobile layout.
- Hero images hidden below the first viewport.
- Overly rounded oversized cards.
- Transparent dropdown panels.
...
### Atlasframe Header Content

Use this content direction inside the desktop dropdowns and mobile drawer.

Services rail:

- WordPress Design
  - Title: `Design systems for clearer WordPress journeys`
  - Description: Plan pages, visual patterns, and conversion paths before production work begins.
  - Details: sitemap and page roles; homepage and service-page composition; responsive content hierarchy; reusable design patterns.
  - Image: `assets/images/hero/agency-workspace.jpg`

- Custom Theme Development
  - Title: `Custom themes built as maintainable systems`
  - Description: Build the theme structure, template parts, SCSS, JavaScript behavior, and documentation around how the site will actually be maintained.
  - Details: custom templates; reusable components; build pipeline; editor settings; launch-ready documentation.
  - Image: `assets/images/hero/developer-screens.jpg`

- WooCommerce
  - Title: `Commerce pages that help buyers decide`
  - Description: Shape WooCommerce storefront experiences around product clarity, trust, and operational handoff.
  - Details: product/category structure; merchandising sections; checkout-adjacent content; store support planning.
  - Image: `assets/images/portfolio/ecommerce-planning.jpg`

- Website Redesign
  - Title: `Redesigns that improve structure, not just style`
  - Description: Rework stale WordPress sites into clearer, faster, easier-to-manage experiences.
  - Details: content audit; visual refresh; performance-minded templates; migration planning; launch QA.
  - Image: `assets/images/portfolio/performance-review.jpg`

- Integrations & Automation
  - Title: `Practical workflows around the website`
  - Description: Connect forms, subscriber flows, CRM handoffs, reporting needs, and admin routines without overcomplicating the site.
  - Details: lead flow mapping; form and newsletter handling; admin workflows; integration-ready architecture.
  - Image: `assets/images/portfolio/team-collaboration.jpg`

- Website Care & Support
  - Title: `Care that keeps the site useful after launch`
  - Description: Maintain the WordPress system, prioritize improvements, and keep content and interactions aligned with the business.
  - Details: update rhythm; QA checklist; improvement backlog; content support; technical stewardship.
  - Image: `assets/images/texture/studio-detail.jpg`

About rail:

- Our Approach
  - Headline: `Start with the structure behind the site`
  - Values: diagnose the current system; define page roles; clarify conversion paths; document technical decisions.
  - CTA: `Learn about the approach` linking to `/about/`.
  - Image: `assets/images/portfolio/team-collaboration.jpg`

- What We Value
  - Headline: `Clear decisions, maintainable code, useful handoff`
  - Values: clarity before decoration; accessibility by default; content that helps buyers decide; documentation as delivery; support after launch.
  - CTA: `Explore values` linking to `/about/`.
  - Image: `assets/images/hero/agency-workspace.jpg`

- How We Work
  - Headline: `A measured path from diagnosis to support`
  - Values: diagnose; frame; design; develop; validate; support.
  - CTA: `See the process` linking to `/about/`.
  - Image: `assets/images/hero/developer-screens.jpg`
...
Each blog card should include an image, tag, title, excerpt, and generated link. Do not use real author names unless the theme uses a generic role such as `Atlasframe Digital`.
