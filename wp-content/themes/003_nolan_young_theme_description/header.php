...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', '003_nolan_young_theme_description' ); ?></a>
<header class="nolan-site-header" data-site-header>
  <div class="nolan-header-inner">
    ...
    <nav class="nolan-primary-nav" aria-label="<?php esc_attr_e( 'Primary navigation', '003_nolan_young_theme_description' ); ?>">
  ...
  <div class="nolan-mobile-drawer" id="nolan-mobile-drawer" data-mobile-drawer hidden>
    <nav aria-label="<?php esc_attr_e( 'Mobile navigation', '003_nolan_young_theme_description' ); ?>">
