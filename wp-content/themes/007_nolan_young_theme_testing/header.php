...
<header class="site-header" data-nolan-menu-header>
  <div class="container header-inner">
    <a class="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_attr_e( 'Northstar Codeworks home', '007_nolan_young_theme_testing' ); ?>">
    ...
    <nav id="primary-menu" class="primary-nav" data-nolan-menu-panel aria-label="<?php esc_attr_e( 'Primary navigation', '007_nolan_young_theme_testing' ); ?>">
