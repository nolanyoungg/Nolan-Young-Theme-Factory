...
Mode: ollama-only
Target folder: wp-content/themes/014_nolan_young_theme_premium_test014
template=NOLAN-YOUNG-theme-000
prepared_slug=014_nolan_young_theme_premium_test014
...
Inside `wp-content/themes/014_nolan_young_theme_premium_test014/`, fully code and fill the theme. Replace Lorem ipsum, add local images/SVGs/logos, improve PHP/CSS/JS, add extra files if needed, and preserve every file from the selected template.
