...
function nytt01_get_services_mega_menu_items() {
	$items = array(
		array(
			'title'       => esc_html__( 'Web Design Systems', 'nolan-young-theme-template-01' ),
			'description' => esc_html__( 'A focused design package for turning a scattered online presence into a clear, conversion-ready WordPress experience.', 'nolan-young-theme-template-01' ),
			'image'       => nytt01_get_navigation_image_uri( 'service-1.svg' ),
			'url'         => home_url( '/services/service-1/' ),
			'subitems'    => array(
				array( 'label' => esc_html__( 'Design direction', 'nolan-young-theme-template-01' ), 'url' => home_url( '/services/service-1/#direction' ) ),
				array( 'label' => esc_html__( 'Page systems', 'nolan-young-theme-template-01' ), 'url' => home_url( '/services/service-1/#systems' ) ),
				array( 'label' => esc_html__( 'Launch plan', 'nolan-young-theme-template-01' ), 'url' => home_url( '/services/service-1/#launch' ) ),
			),
		),
		array(
			'title'       => esc_html__( 'UX and Accessibility', 'nolan-young-theme-template-01' ),
			'description' => esc_html__( 'A collaborative engagement for improving structure, usability, accessibility, and confidence across an existing site.', 'nolan-young-theme-template-01' ),
		...
		array(
			'title'       => esc_html__( 'WordPress Engineering', 'nolan-young-theme-template-01' ),
			'description' => esc_html__( 'Production engineering for maintainable themes, custom integrations, editor workflows, and dependable releases.', 'nolan-young-theme-template-01' ),
		...
		array(
			'title'       => esc_html__( 'Care and Optimization', 'nolan-young-theme-template-01' ),
			'description' => esc_html__( 'Ongoing technical stewardship focused on speed, stability, security, measurement, and controlled improvement.', 'nolan-young-theme-template-01' ),
...
function nytt01_get_about_mega_menu_items() {
	$items = array(
		...
		array(
			'title'       => esc_html__( 'Studio Notes', 'nolan-young-theme-template-01' ),
			'description' => esc_html__( 'See the research, experiments, and working notes shaping Nolan Young Designs projects.', 'nolan-young-theme-template-01' ),
