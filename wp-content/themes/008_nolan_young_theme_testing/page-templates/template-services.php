<?php
/**
 * Template for Choose the right software path for the workflow..
 *
...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Services', '008_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Choose the right software path for the workflow.', '008_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Explore focused services for custom applications, admin portals, integrations, automation, modernization, and discovery.', '008_nolan_young_theme_testing' ); ?></p>
      </div>
