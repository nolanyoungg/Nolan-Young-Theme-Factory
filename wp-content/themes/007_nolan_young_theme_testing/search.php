...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Search', '007_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Search Northstar resources', '007_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Find services, case studies, and planning notes related to custom software and operations systems.', '007_nolan_young_theme_testing' ); ?></p>
      </div>
