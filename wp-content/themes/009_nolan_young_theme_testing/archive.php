...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Insights', '009_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Resource archive', '009_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Browse practical software planning articles, case-study notes, and implementation guidance.', '009_nolan_young_theme_testing' ); ?></p>
      </div>
