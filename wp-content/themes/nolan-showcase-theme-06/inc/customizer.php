...
function nolan_customize_register( $wp_customize ) {
	$wp_customize->add_section(
		'nolan_home',
		array(
			'title'    => __( 'Home Content', 'nolan-showcase-theme-06' ),
			'priority' => 30,
		)
	);
