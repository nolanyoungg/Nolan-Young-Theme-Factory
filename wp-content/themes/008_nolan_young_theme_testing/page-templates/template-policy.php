...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Policy', '008_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Clear project expectations and responsible data handling.', '008_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'This page outlines practical privacy, communication, and project-operation expectations for generated theme previews.', '008_nolan_young_theme_testing' ); ?></p>
      </div>
