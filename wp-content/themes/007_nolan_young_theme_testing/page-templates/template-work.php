...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Work', '007_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Software case studies with operational outcomes.', '007_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Review realistic examples of dashboards, portals, integration layers, and workflow systems built for service businesses and B2B teams.', '007_nolan_young_theme_testing' ); ?></p>
      </div>
