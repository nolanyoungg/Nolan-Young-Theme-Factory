...
<div id="page" class="nytt01-site">
	<header id="masthead" class="nytt01-site-header">
		<div class="nytt01-site-header__bar">
			<div class="nytt01-container nytt01-site-header__bar-inner">
				<span><?php esc_html_e( 'Independent WordPress design engineering', 'nolan-young-theme-template-01' ); ?></span>
				<a href="<?php echo esc_url( home_url( '/services/' ) ); ?>"><?php esc_html_e( 'See services', 'nolan-young-theme-template-01' ); ?></a>
				<a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><?php esc_html_e( 'Plan a build', 'nolan-young-theme-template-01' ); ?></a>
			</div>
		</div>
