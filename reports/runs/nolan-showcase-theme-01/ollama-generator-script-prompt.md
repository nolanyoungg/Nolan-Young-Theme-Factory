...
---FILE: reports/runs/nolan-showcase-theme-01/ollama-create-theme.js---
<complete Node.js script>
---END FILE---

The script will be run from the repository root with:

node reports/runs/nolan-showcase-theme-01/ollama-create-theme.js
...
docs/themes/nolan-showcase-theme-01/
...
Update docs/index.html to include a card linking to themes/nolan-showcase-theme-01/homepage_preview.html.
