	...
	<section class="section portfolio-filter" aria-labelledby="work-filter-title">
		<div class="container">
			<div class="section-heading">
				...
				<h2 id="work-filter-title"><?php esc_html_e( 'Browse the kinds of website problems Stackforge helps organize.', 'nolan-young-template' ); ?></h2>
			</div>
		...
		<div class="container split">
			<div>
				...
				<dl class="case-study__list">
					...
					<dt><?php esc_html_e( 'Solution', 'nolan-young-template' ); ?></dt><dd><?php esc_html_e( 'Stackforge-style templates emphasized services, process, support, and contact flow.', 'nolan-young-template' ); ?></dd>
