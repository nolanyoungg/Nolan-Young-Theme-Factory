...
[ -n "$stage" ] || theme_factory_fail "Usage: bash scripts/ollama/run-ollama-generation-stage.sh <planner|builder|builder-spec|preview|preview-spec|review-fix> <theme-slug> <prompt-file> [target-root]"
