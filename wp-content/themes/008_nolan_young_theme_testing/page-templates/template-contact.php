...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Contact', '008_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Start with the workflow that needs to change.', '008_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Tell Northstar Codeworks what is slow, fragile, duplicated, or disconnected. You will get a practical response about fit and next steps.', '008_nolan_young_theme_testing' ); ?></p>
      </div>
