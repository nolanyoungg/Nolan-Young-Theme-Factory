...
<section class="section blog-preview">
	<div class="container">
		<div class="section-heading section-heading--row"><div><p class="eyebrow"><?php esc_html_e( 'Resources', 'nolan-young-theme-circuit-commerce-studio' ); ?></p><h2><?php esc_html_e( 'Useful website planning articles.', 'nolan-young-theme-circuit-commerce-studio' ); ?></h2></div><a class="btn btn-secondary" href="<?php echo esc_url( home_url( '/blog/' ) ); ?>"><?php esc_html_e( 'Visit blog', 'nolan-young-theme-circuit-commerce-studio' ); ?></a></div>
		<div class="card-grid">
