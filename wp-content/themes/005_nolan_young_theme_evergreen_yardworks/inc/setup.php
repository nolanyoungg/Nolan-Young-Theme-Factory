...
function nolan_young_template_setup() {
	load_theme_textdomain( '005-nolan-young-theme-evergreen-yardworks', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'primary' => esc_html__( 'Primary Navigation', '005-nolan-young-theme-evergreen-yardworks' ),
			'footer'  => esc_html__( 'Footer Navigation', '005-nolan-young-theme-evergreen-yardworks' ),
		)
	);
}
