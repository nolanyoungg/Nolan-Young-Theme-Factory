...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( 'Resources', '007_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Useful guidance before you invest in custom software.', '007_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'Educational notes for founders, operators, and technical buyers planning internal tools, integrations, and workflow automation.', '007_nolan_young_theme_testing' ); ?></p>
      </div>
