...
const slug = 'nolan-showcase-theme-02';
...
function replaceAllText(dir) {
  for (const entry of fs.readdirSync(dir, { withFileTypes: true })) {
    ...
    if (entry.isDirectory()) replaceAllText(full);
      ...
      text = text
        .replaceAll('nolan-showcase-theme-01', 'nolan-showcase-theme-02')
        .replaceAll('Nolan Showcase Theme 01', 'Nolan Showcase Theme 02')
...
const menuJs = fs.readFileSync(path.join(sourceTheme, 'assets', 'js', 'bundle.js'), 'utf8').replaceAll('nolan-showcase-theme-01', 'nolan-showcase-theme-02');
...
function writePreviewFiles() {
  ...
  write(path.join(previewDir, 'README.md'), '# Nolan Showcase Theme 02 Preview\n\nStatic preview for Marlow & Finch Studio.\n');
