...
<main id="primary" class="site-main">
  <section class="hero-section">
    <div class="container hero-grid">
      <div class="hero-copy">
        <p class="eyebrow">Senior software development for operators</p>
        <h1>Reliable custom software for teams outgrowing spreadsheets and duct-taped SaaS.</h1>
        <p class="lede">Northstar Codeworks designs and builds web applications, internal tools, API integrations, and automation systems for B2B teams that need dependable software without corporate drag.</p>
  ...
  <section id="services" class="section"><div class="container section-heading"><p class="eyebrow">Services</p><h2>Software work shaped around real operational pressure.</h2><p>Each engagement starts with workflow mapping, risk review, and a build path that keeps business value visible.</p></div>
<div class="card-grid cards-3">
  ...
  <section id="work" class="section"><div class="container section-heading"><p class="eyebrow">Featured work</p><h2>Credible software outcomes for operational teams.</h2></div>
<div class="case-grid">
