...
<main id="primary" class="site-main">
  <section class="hero-section">
    <div class="container hero-grid">
      <div class="hero-copy">
        <p class="eyebrow">Product-minded engineering partner</p>
        <h1>Design, build, and launch business software with senior technical judgment.</h1>
        <p class="lede">Northstar Codeworks brings product thinking, clean implementation, and practical support to custom apps, workflow automation, and API-heavy software projects.</p>
