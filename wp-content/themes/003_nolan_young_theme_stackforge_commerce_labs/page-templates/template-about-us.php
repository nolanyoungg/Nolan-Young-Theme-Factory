...
<main id="primary" class="site-main page-about">
	<section class="section page-hero"><div class="container split"><div><p class="eyebrow"><?php esc_html_e( 'About Stackforge', 'nolan-young-template' ); ?></p><h1><?php esc_html_e( 'A practical website partner for service and commerce teams.', 'nolan-young-template' ); ?></h1><p><?php esc_html_e( 'Stackforge Commerce Labs helps teams turn scattered ideas, services, and content into WordPress websites that are easier to understand, maintain, and improve.', 'nolan-young-template' ); ?></p></div><?php nolan_young_template_render_image( 'assets/images/hero/about-approach.svg', __( 'Website planning workspace', 'nolan-young-template' ), 'media-frame' ); ?></div></section>
