...
function nolan_theme_setup() {
	load_theme_textdomain( 'nolan-showcase-theme-06', get_theme_file_path( 'languages' ) );
	...
	register_nav_menus(
		array(
			'primary' => __( 'Primary Menu', 'nolan-showcase-theme-06' ),
			'footer'  => __( 'Footer Menu', 'nolan-showcase-theme-06' ),
		)
	);
