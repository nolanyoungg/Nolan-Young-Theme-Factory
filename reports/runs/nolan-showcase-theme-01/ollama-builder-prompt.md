...
The plan file is:
- /c/Users/NolanYoung/codex-ggi-nolan-local/repos/Nolan-Young-Theme-Factory/reports/runs/nolan-showcase-theme-01/plan.md

Task:
- create the complete classic WordPress theme at wp-content/themes/nolan-showcase-theme-01/
...
- create local image assets under wp-content/themes/nolan-showcase-theme-01/assets/images/ and reference them from the templates
...
Use the theme slug `nolan-showcase-theme-01`.
