...
<main id="primary" class="site-main page-work">
	<section class="section page-hero"><div class="container narrow"><p class="eyebrow"><?php esc_html_e( 'Work', 'nolan-young-template' ); ?></p><h1><?php esc_html_e( 'Representative content, commerce, and support problem types.', 'nolan-young-template' ); ?></h1><p><?php esc_html_e( 'These examples show the kinds of strategy, design, development, integration, support, and results-focused work ForgeCart Studio is built to present.', 'nolan-young-template' ); ?></p></div></section>
