...
<section class="section blog-preview">
	<div class="container">
		<div class="section-heading section-heading--row"><div><p class="eyebrow"><?php esc_html_e( 'Resources', 'nolan-young-template' ); ?></p><h2><?php esc_html_e( 'Useful planning notes for WordPress, Shopify, launches, and site care.', 'nolan-young-template' ); ?></h2></div><a class="btn btn-secondary" href="<?php echo esc_url( home_url( '/blog/' ) ); ?>"><?php esc_html_e( 'Visit blog', 'nolan-young-template' ); ?></a></div>
		<div class="card-grid">
