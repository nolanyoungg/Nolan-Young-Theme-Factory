...
<main id="primary" class="site-main">
  <section class="page-hero">
    <div class="container page-hero__grid">
      <div>
        <p class="eyebrow"><?php esc_html_e( '403', '009_nolan_young_theme_testing' ); ?></p>
        <h1><?php esc_html_e( 'Access is restricted.', '009_nolan_young_theme_testing' ); ?></h1>
        <p class="lede"><?php esc_html_e( 'This page is not available for public viewing. Return to the main site or contact the team for help.', '009_nolan_young_theme_testing' ); ?></p>
      </div>
