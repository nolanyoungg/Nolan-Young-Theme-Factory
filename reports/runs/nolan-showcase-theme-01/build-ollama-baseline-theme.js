...
const slug = 'nolan-showcase-theme-01';
...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'nolan-showcase-theme-01' ); ?></a>
<header class="nolan-site-header" data-site-header>
  <div class="nolan-header-inner">
    ...
    <nav class="nolan-primary-nav" aria-label="<?php esc_attr_e( 'Primary navigation', 'nolan-showcase-theme-01' ); ?>">
  ...
  <div class="nolan-mobile-drawer" id="nolan-mobile-drawer" data-mobile-drawer hidden>
    <nav aria-label="<?php esc_attr_e( 'Mobile navigation', 'nolan-showcase-theme-01' ); ?>">
...
`);
  ...
  write(`${themeDir}/searchform.php`, `<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>"><label><span class="screen-reader-text"><?php esc_html_e( 'Search for:', 'nolan-showcase-theme-01' ); ?></span><input type="search" class="search-field" value="<?php echo esc_attr( get_search_query() ); ?>" name="s"></label><button class="button" type="submit"><?php esc_html_e( 'Search', 'nolan-showcase-theme-01' ); ?></button></form>\n`);
  ...
  write(`${themeDir}/comments.php`, `<?php if ( post_password_required() ) { return; } ?><section class="comments-area"><h2><?php esc_html_e( 'Discussion', 'nolan-showcase-theme-01' ); ?></h2><?php comment_form(); ?></section>\n`);
  ...
  const rootTemplateParts = {
    ...
    'content-none.php': `<div class="proof-card"><h2><?php esc_html_e( 'No matching resources found', 'nolan-showcase-theme-01' ); ?></h2><p><?php esc_html_e( 'Try a different search or return to the service overview.', 'nolan-showcase-theme-01' ); ?></p></div>`,
...
function writePreview() {
  ...
  write(`${previewDir}/README.md`, `# Nolan Showcase Theme 01 Preview\n\nStatic preview for Meridian Strategy Group.\n`);
