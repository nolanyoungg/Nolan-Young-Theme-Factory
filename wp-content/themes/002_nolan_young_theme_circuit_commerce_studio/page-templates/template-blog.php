...
<main id="primary" class="site-main page-blog">
	<section class="section page-hero"><div class="container narrow"><p class="eyebrow"><?php esc_html_e( 'Blog', 'nolan-young-theme-circuit-commerce-studio' ); ?></p><h1><?php esc_html_e( 'Website planning and WordPress guidance.', 'nolan-young-theme-circuit-commerce-studio' ); ?></h1><?php get_search_form(); ?></div></section>
