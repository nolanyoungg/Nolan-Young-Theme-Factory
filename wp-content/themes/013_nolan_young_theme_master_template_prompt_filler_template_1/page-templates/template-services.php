  ...
  <section class="services-section-overview">
    <div class="container">
      ...
      <div class="service-card">
        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/placeholder.svg' ) ); ?>" alt="Service 1">
        <h3>Web Design</h3>
        <p>Custom web design solutions that meet your business needs.</p>
        <a href="#" class="btn btn-secondary">Learn More</a>
      </div>
      <div class="service-card">
        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/placeholder.svg' ) ); ?>" alt="Service 2">
        <h3>Web Development</h3>
        <p>Expert web development for modern, scalable websites.</p>
        <a href="#" class="btn btn-secondary">Learn More</a>
      </div>
      <div class="service-card">
        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/placeholder.svg' ) ); ?>" alt="Service 3">
